...
{
    public static final int HEADER_OFFSET = 90;
    ...
    public static final String ENTITY_ATTRIBUTE_DATA_TYPES = "entityAttributeDataTypes";
    ...
    public static final String ENTITY_SEARCH_ADVANCED = "entitySearchAdvanced";

    public static final String ENTITY_SEARCH_BASIC = "entitySearchBasic";
