...
public class AdminConfiguration
{
    ...
    public void setUpdateNotificationRegistrationEntries(List<UpdateNotificationRegistrationEntry> 
        updateNotificationRegistrationEntries) {
        this.updateNotificationRegistrationEntries = updateNotificationRegistrationEntries;
    }

    public void addUpdateNotificationRegistrationEntries(UpdateNotificationRegistrationEntry
            updateNotificationRegistrationEntry) {
	...
	public String toString() {
		return "AdminConfiguration [configFileDirectory=" + configFileDirectory + ", autoStartPIXPDQ="
				+ autoStartPIXPDQ + ", dataDirectory=" + dataDirectory
				+ ", updateNotificationRegistrationEntries=" + updateNotificationRegistrationEntries
				+ "]";
	}
}
