...
{	
    ...
    public Entity getTestEntity() {
        ...
        if (entities.size() == 0) {
            log.error("You need to define some entities in the database for this to work.");
            throw new RuntimeException("Need to define an entity in the database for this to work.");
        }
