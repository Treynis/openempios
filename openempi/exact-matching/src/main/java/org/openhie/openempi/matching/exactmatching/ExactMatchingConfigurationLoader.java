...
public class ExactMatchingConfigurationLoader implements ConfigurationLoader
{
	...
	public void loadAndRegisterComponentConfiguration(ConfigurationRegistry registry, Object configurationFragment) throws InitializationException {
		...
		configurationData.put(ConfigurationRegistry.ENTITY_NAME, matchingConfig.getEntityName());
	...
	public void saveAndRegisterComponentConfiguration(ConfigurationRegistry registry, Map<String,Object> configurationData)
		...
		MatchingConfigurationType xmlConfigurationFragment = buildMatchingConfigurationFragment(fields, configurationData);
	...
	private org.openhie.openempi.configuration.xml.MatchingConfigurationType buildMatchingConfigurationFragment(List<MatchField> fields, Map<String, Object> data) {
		...
		matchingType.setEntityName((String) data.get(ConfigurationRegistry.ENTITY_NAME));
