...
public class MatchConfigurationWeb extends BaseModelData implements Serializable
{
	...
	public static final String INITIAL_M_VALUE_KEY = "initialMValue";
	public static final String INITIAL_U_VALUE_KEY = "initialUValue";
	public static final String INITIAL_P_VALUE_KEY = "initialPValue";
	public static final String MAX_ITERATIONS_KEY = "maxIterations";
	public static final String CONVERGENCE_ERROR_KEY = "convergenceError";
	...
	public static final String LOGGING_BY_VECTORS_KEY = "loggingByVectors";
	public static final String LOGGING_BY_VECTORS_VECTORS_KEY = "loggingVectorsIntegerSet";
	public static final String LOGGING_BY_VECTORS_FRACTION_KEY = "loggingVectorsFraction";
	public static final String LOGGING_BY_WEIGHT_KEY = "loggingByWeight";
	public static final String LOGGING_BY_WEIGHT_LOWER_BOUND_KEY = "loggingWeightLowerBound";
	public static final String LOGGING_BY_WEIGHT_UPPER_BOUND_KEY = "loggingWeightUpperBound";
	public static final String LOGGING_BY_WEIGHT_FRACTION_KEY = "loggingWeightFraction";
	public static final String LOGGING_DESTINATION = "loggingDestination";

	public static final String LOG_TO_FILE_DESTINATION = "Log to File";
	public static final String LOG_TO_DB_DESTINATION = "Log to DB";

	public static final String VECTOR_CONFIGURATIONS = "vectorConfigurations";
	...
	public java.lang.Double getConvergenceError() {
	    return get(CONVERGENCE_ERROR_KEY);
	}

	public void setConvergenceError(java.lang.Double convergenceError) {
	    set(CONVERGENCE_ERROR_KEY, convergenceError);
	}
