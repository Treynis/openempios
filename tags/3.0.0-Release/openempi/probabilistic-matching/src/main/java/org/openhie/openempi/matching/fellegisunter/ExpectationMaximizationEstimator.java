...
public class ExpectationMaximizationEstimator
{
	...
	public synchronized void estimateMarginalProbabilities(FellegiSunterParameters params, double mInitial, 
	        double uInitial, double pInitial, int maxIterations, double convergenceError) {
