...
public class LoggedLinkListWeb extends BaseModel implements Serializable
{
	...
	public java.util.List<RecordLinkWeb> getRecordPairs() {
		return get("recordPairs");
	}
	
	public void setRecordPairs(java.util.List<RecordLinkWeb> recordPairs) {
		set("recordPairs", recordPairs);
	}
}
