...
public class AppEvents
{
	...
	public static final EventType AuditEventEntryView = new EventType();
	...
	public static final EventType BlockingHPConfigurationReceived = new EventType();

	public static final EventType BlockingHPConfigurationSave = new EventType();

	public static final EventType BlockingHPConfigurationSaveComplete = new EventType();

	public static final EventType BlockingHPConfigurationView = new EventType();
    ...
    public static final EventType DataProfileListView = new EventType();

    public static final EventType DataProfileListRequest = new EventType();

    public static final EventType DataProfileListReceived = new EventType();

	public static final EventType DataProfileView = new EventType();

	public static final EventType DataProfileDelete = new EventType();

	public static final EventType DataProfileDeleteComplete = new EventType();
	...
	public static final EventType EntityAttributeView = new EventType();

	public static final EventType EntitiesRequest = new EventType();

	public static final EventType EntitiesReceived = new EventType();

	public static final EventType EntityInstancesRequest = new EventType();

	public static final EventType EntityBasicInstancesRequest = new EventType();

	public static final EventType EntityInstancesReceived = new EventType();

	public static final EventType EntityAddView = new EventType();

	public static final EventType EntityUpdateView = new EventType();

	public static final EventType EntityBasicUpdateView = new EventType();

	public static final EventType EntityDeleteView = new EventType();

	public static final EventType EntityBasicDeleteView = new EventType();

	public static final EventType EntityLinkView = new EventType();

	public static final EventType EntityLinkPairsRequest = new EventType();

	public static final EventType EntityOneLinkPairRequest = new EventType();

	public static final EventType EntityByIdRequest = new EventType();

	public static final EventType EntityLinksForFixedSearchRequest = new EventType();

	public static final EventType EntityLinksRequest = new EventType();

	public static final EventType EntityLinksReceived = new EventType();

	public static final EventType UpdateEntityRenderData = new EventType();

	public static final EventType DeleteEntityRenderData = new EventType();

	public static final EventType EntityAdd = new EventType();

	public static final EventType EntityAddComplete = new EventType();

	public static final EventType EntityUpdate = new EventType();

	public static final EventType EntityBasicUpdate = new EventType();

	public static final EventType EntityUpdateCancel = new EventType();

    public static final EventType EntityBasicUpdateCancel = new EventType();

	public static final EventType EntityUpdateComplete = new EventType();

	public static final EventType EntityUpdateFinished = new EventType();

    public static final EventType EntityBasicUpdateFinished = new EventType();

	public static final EventType EntityDelete = new EventType();

    public static final EventType EntityBasicDelete = new EventType();

	public static final EventType EntityDeleteCancel = new EventType();

    public static final EventType EntityBasicDeleteCancel = new EventType();

	public static final EventType EntityDeleteComplete = new EventType();

	public static final EventType EntityDeleteFinished = new EventType();
	...
	public static final EventType KeyValueSetView = new EventType();
    ...
    public static final EventType GlobalIdentifierDomainReceived = new EventType();
	...
	public static final EventType UpdateConfigurationMenu = new EventType();
	...
	public static final EventType ValidationRuleReceived = new EventType();

	public static final EventType JobTypesReceived = new EventType();

	public static final EventType JobStatusesReceived = new EventType();

	public static final EventType JobQueueView = new EventType();

	public static final EventType JobEntriesRequest = new EventType();

    public static final EventType JobEntriesReceived = new EventType();

    public static final EventType JobEntryEnentLogsRequest = new EventType();

    public static final EventType JobEntryEnentLogsReceived = new EventType();

    public static final EventType JobEntryRemove = new EventType();

    public static final EventType JobEntryDescriptionUpdate = new EventType();
}
