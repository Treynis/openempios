...
public class FileLoaderManager extends BaseSpringApp
{
	...
	public String loadFile(String filename, String loaderAlias, Entity entity) {
	...
	public static void main(String[] args) {
        ...
        map.put("isMassiveInsert", isMassiveInsert);
		...
		try {
			...
			fileLoaderManager.loadFile(filename, loaderAlias, entities.get(0));
	        try {
	...
	public static void usage() {
		System.out.println("Usage: " + FileLoaderManager.class.getName() + " <file-to-load> <loader-alias> <entity-name> [<import-data-boolean-flag>]");
	}
}
