...
public class AuditEventType extends BaseObject implements java.io.Serializable
{
	...
	public static final String LINK_PERSON_EVENT_TYPE = "LNK";
	public static final String UNLINK_PERSON_EVENT_TYPE = "ULK";
	...
	public static final String ADD_RECORD_EVENT_TYPE = "ADDR";
	public static final String DELETE_RECORD_EVENT_TYPE = "DELR";
	public static final String IMPORT_RECORD_EVENT_TYPE = "IMPR";
	public static final String MERGE_RECORD_EVENT_TYPE = "MRGR";
	public static final String UNMERGE_RECORD_EVENT_TYPE = "UMGR";
	public static final String UPDATE_RECORD_EVENT_TYPE = "UPDR";
	public static final String LINK_RECORD_EVENT_TYPE = "LNKR";
	public static final String UNLINK_RECORD_EVENT_TYPE = "ULKR";
